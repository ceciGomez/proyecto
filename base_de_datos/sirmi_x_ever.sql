...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2017 a las 01:38:37
...
INSERT INTO `usuarioescribano` (`idEscribano`, `nomyap`, `usuario`, `contraseña`, `fechaReg`, `dni`, `telefono`, `direccion`, `email`, `matricula`, `estadoAprobacion`, `idLocalidad`, `idUsuario`, `motivoRechazo`, `foto`) VALUES
(1, 'Andrea Moreno', 'amoreno', 'b4d978e9eb36fadf5f38a3ec64c1da8b', '2017-02-22 00:14:47', 12457897, 303456, 'Arbo y Blanco 550', 'amoreno@arnet.com.ar', 12345, NULL, 4, 1, NULL, ''),
(2, 'Fabricio Acosta', 'facosta', '57bae1643a29f9bc182508da65822ed1b840da24', '2017-02-22 00:14:47', 15889966, 303459, 'J. D. Perón 1445', 'facosta@google.com', 4587, NULL, 6, 2, NULL, ''),
(3, 'Margarita Sosa', 'msosa', 'f3842765018418f92434c2e601661adea6cb22b9', '2017-02-22 00:14:47', 13889966, 303457, 'Av. Alvear 45', 'msosa@hotmail.com', 4587, NULL, 1, 2, NULL, ''),
(4, 'DARIO NUNIEZ', 'GERMANNZ3', 'bf0980b4c067c7b9dd83efd2c7fec7316eeecbbe', '2017-02-22 00:14:47', 33939195, 0, NULL, 'GERMAN.NZ03@GMAIL.COM', 303456, 'p', NULL, NULL, '', ''),
(5, 'CARLOS NELSON ACOSTA', 'HOLA123', 'c49868c59d03dc485ba93e03aa1dc1f7922a582c', '2017-02-22 00:14:47', 33564787, 0, NULL, 'HOLA@GMAIL.COM', 45645, 'p', NULL, NULL, '', ''),
...
(7, 'escribano', 'escribano', 'b985651180f215acd5b8e34fabfa0a1174d71970', '2017-02-22 00:14:47', 9282828, 828282, 'Perrando 8182', 'escribano@catastro.com', 373373, 'A', 1, NULL, NULL, ''),
(8, 'PEDRO AZNAR', 'paznar', '882af4d7a33af52b5653ddcae036aee2be8f0568', '2017-02-22 00:14:47', 1823564, 2147483647, 'PERON 1233', 'paznar@gmail.com', 124598, 'P', 6, NULL, '', ''),
(9, 'CARLOS YORIK', 'cyorik', '0edce019660e99cfd4cb1c15acc00bca05d7d1f5', '2017-02-22 00:14:47', 457896, 2147483647, 'AS123', 'YORIK@GMAIL.COM', 456987, 'P', 6, NULL, '', '');
...
INSERT INTO `usuariosys` (`idUsuario`, `nomyap`, `usuario`, `contraseña`, `fechaReg`, `dni`, `telefono`, `direccion`, `email`, `idLocalidad`, `tipoUsuario`, `foto`) VALUES
(1, 'pablo lopezzzss', 'plopez', 'fe8cf3a963df912ad60c5db8e7f73d404607a10e', '2017-02-22 00:14:07', 21112211, 3034561, 'Frondizi 500', 'plopez@gmail.com', 1, 'O', NULL),
(2, 'Lucas Vallejos', 'lvallejos', '368d292d0839d209380b6531c2b266d8994ff893', '2017-02-22 00:14:07', 33559988, 303456, 'Arturo Illia 123', 'lvallejos@hotmail.com', 2, 'O', NULL),
(3, 'Ana Medina', 'amedina', 'c2219aefa93c5d46c81f1f739ff06f9dd0637664', '2017-02-22 00:14:07', 12558878, 303457, 'Monteagudo 23', 'amedina@hotmail.com', 3, 'A', NULL),
(4, 'operador', 'operador', '9d24de3ac7b5fbbe776a6d90fe25a7e3c74a29cc', '2017-02-22 00:14:07', 36737373, 7373737, 'chaco 171', 'operador@gmail.com', 1, 'O', NULL),
(5, 'admin', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '2017-02-22 00:14:07', 28288828, 227227, 'chaco 8282', 'administrador@gmail.com', 1, 'A', NULL);
...
--
ALTER TABLE `usuarioescribano`
  MODIFY `idEscribano` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `usuariosys`
--
ALTER TABLE `usuariosys`
  MODIFY `idUsuario` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
