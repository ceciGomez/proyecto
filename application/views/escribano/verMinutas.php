              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-sm " href="<?=base_url().'index.php/c_escribano/verUnaMinuta'?>">  <button><i class="fa fa-eye"></i></button>
                    <a class="btn btn-sm " href="<?=base_url().'index.php/c_escribano/verPropietarios'?>">  <button><i class="fa fa-users"></i></button>
                    <a class="btn btn-sm " href="<?=base_url().'index.php/c_escribano/imprimirMinuta'?>">  <button><i class="fa fa-print"></i></button>
                ...
                <tr>
                 ...
                 <td>Falta cargar datos de propietario</td>
                  <td><a class="btn btn-sm " href="<?=base_url().'index.php/c_escribano/editarMinuta'?>"><button><i class="fa fa-pencil"></i></button></a> 
