            ...
            <div class="box-header">
                ...
                <div class="modal" id="Eliminar">
                 ...
                 $.post("<?=base_url()?>index.php/c_administrador/motivoRechazo",{idEscribano:idEscribano}, function(data){
                   ...
                   function aceptar( ){
                    $.post("<?=base_url()?>index.php/c_administrador/aceptar_esc",{idEscribano:idEsc,idUsuario:idUsr}, function(data){
                   ...
                   function rechazar( ){
                    ...
                    $.post("<?=base_url()?>index.php/c_administrador/rechazar_esc",{idEscribano:idEsc,motivoRechazo:motivoRechazo,idUsuario:idUsr}, function(data){
