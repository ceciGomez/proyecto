         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <?php if($exito==TRUE){
                     ?>
                  <a href="<?=base_url().'index.php/c_operador/verPerfil'?>" class="btn btn-primary" >Aceptar</a>
                  <?php } ?>
               </div>
            </div>
         </div>
            ...
            <div class="box box-primary" >
               <div class="box-body">
                  <div class="form-group">
                     <?=form_open(base_url().'index.php/c_operador/actualizarOperador')?>
                     <div class="row">
                        <div class="col-md-3">
                           <label>Nombre y Apellido:</label><br>
                           <input type='text' name="nomyap" id="nomyap" placeholder="Nombre y Apellido" value='<?php echo $unOperador[0]->nomyap; ?>'  style="text-transform:uppercase;" onkeypress="return validar(event)" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                        <div class="col-md-3">
                           <label>Usuario :</label><br>
                           <input type="text"  value="<?php echo $unOperador[0]->usuario ?>" name="usuario" id="usuario" placeholder="Usuario">
                        </div>
                        <div class="col-md-3">
                           <label>DNI :</label><br>
                           <input type="text" value="<?php echo $unOperador[0]->dni ?>" name="dni" id="dni" placeholder="DNI" maxlength="8" onkeypress="return NumbersOnly(event);">
                        </div>
                        <div class="col-md-3">
                           <label>Email :</label><br>
                           <input type="text"  value="<?php echo $unOperador[0]->email ?>" name="email" id="email" placeholder="email">
                        </div>
                        <div class="col-md-3">
                           <label>Telefono :</label><br>
                           <input type="text" maxlength="15"   placeholder="+54" value="<?php echo $unOperador[0]->telefono ?>" name="telefono" id="telefono" placeholder="teléfono" onkeypress="return NumbersOnly(event);">
                        </div>
                        <div class="col-md-3">
